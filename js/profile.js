...
(function () {
  ...
  */
    ...
    if (!regs.length) {
      list.innerHTML = `
        <div class="pf-empty">
          ...
          <a href="hackathon.html" class="pf-ns-btn-link" style="display:inline-flex; margin-top: 14px;">Explore Hackathons</a>
        </div>`;
      return;
    }
        ...
        nextStepHtml = `
          <div class="pf-next-step-box pf-ns-info">
            ...
            <div class="pf-ns-btn-row">
              <a href="teamfinder.html" class="pf-ns-btn-link">Find More Teams</a>
  ...
  function renderCreated() {
    ...
    if (activeList) renderList(activeList, activeTeams, `No active teams yet.<br>Go to <a href="teamfinder.html" style="color:#c9a227;">Team Finder</a> to create one.`, 'Open');
      ...
      upgradeBtn.addEventListener('click', () => {
        ...
        if (email) {
          ...
          if (profiles[email]) {
            ...
            if (current === 'free') {
              window.location.href = 'upgrade.html?reason=profile_upgrade&redirect=' + encodeURIComponent(window.location.href);
            } else {
